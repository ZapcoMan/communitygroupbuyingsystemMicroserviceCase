...
const fetchData = async () => {
  ...
  try {
    ...
    const res = await request.get('/discussshangpinxinxi/list', { params })
    if (res.code === 0) {
...
const handleSubmitReply = async () => {
  try {
    const res = await request.post('/discussshangpinxinxi/update', replyForm)
    if (res.code === 0) {
...
const handleDelete = async (id) => {
  try {
    ...
    const res = await request.post('/discussshangpinxinxi/delete', [id])
    if (res.code === 0) {
...
const handleBatchDelete = async () => {
  ...
  try {
    ...
    const res = await request.post('/discussshangpinxinxi/delete', ids)
    if (res.code === 0) {
