      ...
      >
        ...
        <el-table-column prop="tupian" label="封面图片" width="100">
          <template #default="scope">
            <img v-if="scope.row.tupian" :src="baseUrl + scope.row.tupian" class="table-img">
          </template>
        </el-table-column>
        <el-table-column prop="introduction" label="简介" show-overflow-tooltip></el-table-column>
        <el-table-column prop="clicknum" label="阅读数" width="100"></el-table-column>
...
const handleAdd = () => {
  ...
  Object.assign(form, { id: '', title: '', tupian: '', introduction: '', content: '' })
